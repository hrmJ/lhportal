...
/**
 *
 * Hallitsee yhteyksiä sqlitetietokantaan.
 *
 *
 **/
class SqliteCon extends DbCon{

    /**
     * Tietokannan perustiedot
     *
     * @param string $file tietokannan sisältävä tiedosto
     * @param boolean $connect yhdistetäänkö heti vai ei 
     *
     **/
    public function __construct ($file,$connect=True) {
        $this->file=$file;
        if($connect)
            $this->Connect();
    }
